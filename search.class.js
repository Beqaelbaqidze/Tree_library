...
export class SearchClass {
  ...
  htmlULTpl = (
    ...
    return `
      ...
      <button class="parentNode btnTree" data-parent-id="${parentId}" data-text="${textTitle}"><svg class="treeArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
